        ...
        <div class="card">
            ...
            <div class="input-group p-3">
                <form action="" method="get">
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-outline-secondary" type="submit" <?= isset($_GET['page']) ? 'name="page" value="' . $_GET['page'] . '"' : '' ?>><i class="bi bi-search"></i></button>
                    </div>
                </form>
            </div>
            ...
            <div class="card-body text-center">
                ...
                for ($page = 1; $page <= $number_of_pages; $page++) { ?>
                    <a class="px-2 <?= (isset($_GET['page'])) ? (($_GET['page'] != $page) ? 'text-decoration-none text-black' : 'text-info')  : 'text-black' ?>" href="<?= isset($_GET["searchPatient"]) ? 'liste-patients.php?searchPatient='. $_GET['searchPatient']. '&page=' .  $page  : 'liste-patients.php?page=' .  $page ?>"><?= $page ?></a>
                <?php } ?>
            </div>
